...
final class JWTDecoder implements DecodedJWT, Serializable {
    ...
    JWTDecoder(JWTParser converter, String jwt) throws JWTDecodeException {
        ...
        String payloadJson;
        try {
            headerJson = new String(Base64.decode(parts[0],Base64.URL_SAFE), StandardCharsets.UTF_8);
            payloadJson = new String(Base64.decode(parts[1],Base64.URL_SAFE), StandardCharsets.UTF_8);
